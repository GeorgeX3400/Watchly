...
urlpatterns = [
    ...
    path('watches/<int:id>', views.WatchView.as_view(), name='watch'),
    ...
    path('get_token/', views.CSRFTokenView.as_view(), name='get_token'),
    path('offer/', views.offer_view, name='oferta'),
